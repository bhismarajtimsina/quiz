...
if(isset($_POST['update_details'])) {
    ...
    if(!empty($password)) {
        ...
        $query = "UPDATE user SET name='$username', email='$email', password='$password', college='$college' WHERE email='$email'";
    } else {
        // Update the user's details in the database without changing the password
        $query = "UPDATE user SET name='$username', email='$email', college='$college' WHERE email='$email'";
    }
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <li <?php echo''; ?> >
         <a href="logout.php?q=welcome.php">
  ...
  Edit Details
    ...
    if(isset($_SESSION['name'])) {
        echo "<p style='text-align:right; color:black; margin-right:184px;margin-top: 13px;'>Welcome, " . $user . "</p>";
    }
    ?>
    ...
    <div class="modal-content">
      ...
      <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="college" name="college" value="<?php echo $name; ?>">
        </div>
      </div>
